...
import '../controllers/my_invoice_details.dart';
import '../uitheme/style.dart';

class MyInvoiceResponse extends StatelessWidget {
  final List json;
  final ScrollController scrollController;

  MyInvoiceResponse({required this.json, required this.scrollController});
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        MyInvoiceDetailsClass(item_id: json[index]['item_id']),
                  ),
                );
              },
              child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Wrap(
                                children: [
                                  Text(
                                    "Date : " + json[index]['item_date_time'],
